...
New-Alias -Name raspberrypi-1.lan -Value C:\Users\jkoshita\.ssh\login\raspberrypi-1.ps1
# ssh -i /Users/jkoshita/.ssh/raspberrypi-1.lan -L 5900:localhost:5900 jkoshita@raspberrypi-1.lan

New-Alias -Name raspberrypi-2.lan -Value C:\Users\jkoshita\.ssh\login\raspberrypi-2.ps1
